    ...
    var tabNomal;
      ...
      return(
        <TabNavigatorItem
         ...
         renderBadge={()=>isBadge?<View style={styles.badgeView}><Text style={styles.badgeText}>0</Text></View>:null}
        >
        {
          tabName=='Home'?<Home/>:
  ...
  /**
   ...
   tabBarView(){
     return (
       ...
       >
       {this.renderTabView('首页','Home','首页板块',true)}
       {this.renderTabView('分类','Classify','分类板块',false)}
       {this.renderTabView('外包','Waibao','外包板块',false)}
